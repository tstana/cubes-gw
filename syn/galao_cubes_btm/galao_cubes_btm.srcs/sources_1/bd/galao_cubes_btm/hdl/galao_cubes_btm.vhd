...
--Date        : Fri Dec 16 18:35:22 2016
--Host        : DESKTOP-HH2BVI2 running 64-bit major release  (build 9200)
--Command     : generate_target galao_cubes_btm.bd
--Design      : galao_cubes_btm
...
entity galao_cubes_btm is
  ...
  attribute CORE_GENERATION_INFO of galao_cubes_btm : entity is "galao_cubes_btm,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=galao_cubes_btm,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of galao_cubes_btm : entity is "galao_cubes_btm.hwdef";
end galao_cubes_btm;

architecture STRUCTURE of galao_cubes_btm is
  component galao_cubes_btm_processing_system7_0_0 is
  port (
  ...
  end component galao_cubes_btm_processing_system7_0_0;
...
processing_system7_0: component galao_cubes_btm_processing_system7_0_0
     port map (
