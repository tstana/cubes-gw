...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set stat_led_o [ create_bd_port -dir O -from 1 -to 0 stat_led_o ]
...
CONFIG.PCW_WDT_WDT_IO.VALUE_SRC {DEFAULT} \
  ...
  connect_bd_net -net processing_system7_0_GPIO_O [get_bd_ports stat_led_o] [get_bd_pins processing_system7_0/GPIO_O]
...
preplace portBus stat_led_o -pg 1 -y 100 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -y 180 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 1 1 NJ
preplace netloc processing_system7_0_GPIO_O 1 1 1 NJ
preplace netloc processing_system7_0_FIXED_IO 1 1 1 NJ
preplace netloc processing_system7_0_FCLK_CLK1 1 0 2 20 330 400
levelinfo -pg 1 0 210 440 -top 0 -bot 350
",
}
